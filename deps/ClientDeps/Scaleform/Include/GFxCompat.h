...
//
// Note: typically this new code needs to be added when porting to GFx 4.0
//
...
typedef SF::Render::AmpRenderer         GAmpRenderer;
...
typedef GFx::SpecialKeysState           GFxSpecialKeysState;
#endif
