...
template <class T>
inline T*  Construct(void *p, const T& source)
{
...
inline T*  ConstructAlt(void *p, const S& source)
{
    return ::new(p) T(source);
}

template <class T, class S1, class S2>
inline T*  ConstructAlt(void *p, const S1& src1, const S2& src2)
{
    return ::new(p) T(src1, src2);
}

template <class T>
inline void ConstructArray(void *p, UPInt count)
{
    UByte *pdata = (UByte*)p;
...
template <class T>
inline void ConstructArray(void *p, UPInt count, const T& source)
{
    UByte *pdata = (UByte*)p;
    for (UPInt i=0; i< count; ++i, pdata += sizeof(T))
    {
...
template <class T>
inline void Destruct(T *pobj)
{
    pobj->~T();
}

template <class T>
inline void DestructArray(T *pobj, UPInt count)
{   
