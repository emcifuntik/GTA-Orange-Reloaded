...
class ThreadList : public NewOverrideBase<Stat_Default_Mem>
{
    ...
    void finishAllThreads()
    {
        ...
        SF_ASSERT(GetCurrentThreadId() == RootThreadId);
...
bool    Thread::Start(ThreadState initialState)
{
    ...
    ThreadHandle = (HANDLE) _beginthreadex(0, (unsigned)StackSize, Thread_Win32StartFn, this, 0, 0);
