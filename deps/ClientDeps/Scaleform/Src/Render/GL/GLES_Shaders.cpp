...
"// E Position3d\n"
"\n"
"  gl_Position =(pos) * ( vfmuniforms[int(0.1+1.0*batch+0.0)]);\n"
"  vbatch = batch;\n"
"\n"
"}";
...
"\n"
"  gl_Position = pos;\n"
"  gl_Position.x = dot(pos, vfuniforms[int(0.1+2.0*batch+0.0+(0.0))]);\n"
"  gl_Position.y = dot(pos, vfuniforms[int(0.1+2.0*batch+0.0+(1.0))]);  \n"
"  vbatch = batch;\n"
"\n"
"}";
...
"// E TexTG\n"
"\n"
"  tc.x = dot(pos, vfuniforms[int(0.1+2.0*batch+0.0+(0.0))]);\n"
"  tc.y = dot(pos, vfuniforms[int(0.1+2.0*batch+0.0+(1.0))]);\n"
"// E Position3d\n"
"\n"
"  gl_Position =(pos) * ( vfmuniforms[int(0.1+1.0*batch+0.0)]);\n"
"  vbatch = batch;\n"
...
"// S TexTG\n"
"\n"
"  tc0.x = dot(pos, vfuniforms[int(0.1+2.0*batch+0.0+(0.0))]);\n"
"  tc0.y = dot(pos, vfuniforms[int(0.1+2.0*batch+0.0+(1.0))]);\n"
"// S \n"
"  color = acolor;\n"
"// S \n"
"  factor = afactor;\n"
...
"// E TexTG\n"
"\n"
"  tc.x = dot(pos, vfuniforms[int(0.1+4.0*batch+0.0+(0.0))]);\n"
"  tc.y = dot(pos, vfuniforms[int(0.1+4.0*batch+0.0+(1.0))]);\n"
"// E position\n"
"\n"
"\n"
"  gl_Position = pos;\n"
"  gl_Position.x = dot(pos, vfuniforms[int(0.1+4.0*batch+2.0+(0.0))]);\n"
"  gl_Position.y = dot(pos, vfuniforms[int(0.1+4.0*batch+2.0+(1.0))]);  \n"
"  vbatch = batch;\n"
"\n"
"}";
...
"// S TexTG\n"
"\n"
"  tc0.x = dot(pos, vfuniforms[int(0.1+4.0*batch+0.0+(0.0))]);\n"
"  tc0.y = dot(pos, vfuniforms[int(0.1+4.0*batch+0.0+(1.0))]);\n"
"// S \n"
"  color = acolor;\n"
"// S \n"
"  factor = afactor;\n"
...
"// S TexTG\n"
"\n"
"  tc1.x = dot(pos, vfuniforms[int(0.1+4.0*batch+0.0+(2.0+0.0))]);\n"
"  tc1.y = dot(pos, vfuniforms[int(0.1+4.0*batch+0.0+(2.0+1.0))]);\n"
"// S \n"
"  factor = afactor;\n"
"// E Position3d\n"
"\n"
...
"// S TexTG\n"
"\n"
"  tc0.x = dot(pos, vfuniforms[int(0.1+6.0*batch+0.0+(0.0))]);\n"
"  tc0.y = dot(pos, vfuniforms[int(0.1+6.0*batch+0.0+(1.0))]);\n"
"// S TexTG\n"
"\n"
"  tc1.x = dot(pos, vfuniforms[int(0.1+6.0*batch+0.0+(2.0+0.0))]);\n"
"  tc1.y = dot(pos, vfuniforms[int(0.1+6.0*batch+0.0+(2.0+1.0))]);\n"
"// S \n"
"  factor = afactor;\n"
"// E position\n"
"\n"
"\n"
"  gl_Position = pos;\n"
"  gl_Position.x = dot(pos, vfuniforms[int(0.1+6.0*batch+4.0+(0.0))]);\n"
"  gl_Position.y = dot(pos, vfuniforms[int(0.1+6.0*batch+4.0+(1.0))]);  \n"
"  vbatch = batch;\n"
"\n"
"}";
...
"// S TexTG\n"
"\n"
"  tc1.x = dot(pos, texgen[int(0.1+2.0+0.0)]);\n"
...
"void main() {\n"
"// E Solid\n"
"  gl_FragColor = ffuniforms[int(0.1+1.0*vbatch+0.0)];\n"
"// E none\n"
"  ;\n"
"\n"
"}";
...
"void main() {\n"
"// E Text\n"
"  vec4 c = color * ffuniforms[int(0.1+2.0*vbatch+0.0)] + ffuniforms[int(0.1+2.0*vbatch+1.0)];\n"
