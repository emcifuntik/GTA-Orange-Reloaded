...
bool BundleEntry::UpdateBundleEntry(TreeCacheRoot* tr, Renderer2DImpl* r)
{
    Key.UpdateBundleEntry(this, tr, r);
...
void BundleEntryRange::StripChainsByDepth(unsigned topDepth)
{
    ...
    volatile static BundleEntry* prevSaved;
    prevSaved = 0;
