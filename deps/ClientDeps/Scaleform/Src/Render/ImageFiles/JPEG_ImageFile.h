...
public:
    ...
    virtual Render::MemoryBufferImage* CreateMemoryBufferImage
        (File* file, const ImageCreateArgs& args, UInt64 sz) =0;
    virtual ImageSource* CreateWrapperImageSource(Render::MemoryBufferImage* memImage) const =0;
...
public:
    ...
    virtual ImageSource* CreateWrapperImageSource(Render::MemoryBufferImage* memImage) const;
...
public:
    ...
    const UByte* GetData() const { return &FileData[0]; }
    UPInt        GetDataSize() const { return FileData.GetSize(); }
