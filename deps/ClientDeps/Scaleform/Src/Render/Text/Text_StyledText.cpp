            ...
            if (run.pFormat)
            {
                ...
                if (pimage)
                {
                    ...
                    if (pimage->ScreenWidth > 0)
                        Format(retStr, " WIDTH=\"{0}\"", pimage->ScreenWidth);
                    if (pimage->ScreenHeight > 0)
                        Format(retStr, " HEIGHT=\"{0}\"", pimage->ScreenHeight);
                    if (pimage->VSpace != 0)
                        Format(retStr, " VSPACE=\"{0}\"", pimage->VSpace);
                    if (pimage->HSpace != 0)
                        Format(retStr, " HSPACE=\"{0}\"", pimage->HSpace);
