...
class DocView : public RefCountBase<DocView, StatRender_Text_Mem>
{
    ...
    //@REN typedef Render::Renderer::BitmapDesc BitmapDesc;
...
public:
    ...
    void SetFilters(const TextFilter& f) { Filter = f; } 
    ...
    void  SetShadowBlurX(float v) { Filter.ShadowBlurX = v; }
    float GetShadowBlurX() const  { return Filter.ShadowBlurX; }

    void  SetShadowBlurY(float v) { Filter.ShadowBlurY = v; }
    float GetShadowBlurY() const  { return Filter.ShadowBlurY; }

    void  SetShadowStrength(float v) { Filter.ShadowStrength = v; }
    float GetShadowStrength() const  { return Filter.ShadowStrength; }
    ...
    void  SetShadowColor(unsigned c) { Filter.ShadowColor = (c & 0xFFFFFFu) | Filter.ShadowAlpha << 24; }
    unsigned GetShadowColor() const { return Filter.ShadowColor.ToColor32() & 0xFFFFFFu; }

    void  SetShadowAlpha(float a) { Filter.ShadowAlpha = UByte(Alg::Clamp(a * 255.0f, 0.0f, 255.0f)); Filter.ShadowColor.SetAlpha(Filter.ShadowAlpha); }
