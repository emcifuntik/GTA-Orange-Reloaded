...
{
    SF_ASSERT(Sx != FLT_MAX && Sy != FLT_MAX);
    SF_ASSERT(MatProj && MatView && MatWorld);

	if (MatProj==NULL || MatView==NULL || MatWorld==NULL)
		return;
