...
public:
    ...
    {
        unsigned frontSize = 
            MatrixElementSizeTable[formatBits&Has_TableMask].Offsets[3];
...
{    
    ...
    List<HandlePage>    FullPages;
    List<HandlePage>    PartiallyFreePages;
...
// allocated unless used) and allows matrix memory to be de-fragmented
