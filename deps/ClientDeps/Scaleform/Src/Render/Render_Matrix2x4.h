...
class Matrix2x4 : public Matrix2x4Data<T>
{
 public:
    ...
    inline    void     SetToAppend(const Matrix2x4& m0, const Matrix2x4& m1, const Matrix2x4& m2);
...
template<typename T>
void Matrix2x4<T>::SetToAppend(const Matrix2x4<T>& m0,
