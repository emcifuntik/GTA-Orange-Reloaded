...
typedef HashSetUncachedLH<ASStringNode*,
                           ...
                           ASStringNodeHashFunc<ASStringNode*>,
                           StatMV_ActionScript_Mem>              ASStringNodeHash;




class ASStringManager : public RefCountBase<ASStringManager, StatMV_ActionScript_Mem>
{    
...
template <class U>
class ASStringHash : public ASStringHashBase<U, HashUncachedLH<ASString, U, ASStringHashFunctor, StatMV_ActionScript_Mem> >
{
    typedef ASStringHash<U>                                                                  SelfType;
    typedef ASStringHashBase<U, HashUncachedLH<ASString, U, ASStringHashFunctor, StatMV_ActionScript_Mem> >   BaseType;
...
template <class U>
class ASStringHash_GC : public ASStringHashBase<U, HashUncachedLH_GC<ASString, U, ASStringHashFunctor, StatMV_ActionScript_Mem> >
{
    typedef ASStringHash_GC<U>                                                               SelfType;
    typedef ASStringHashBase<U, HashUncachedLH_GC<ASString, U, ASStringHashFunctor, StatMV_ActionScript_Mem> >   BaseType;
