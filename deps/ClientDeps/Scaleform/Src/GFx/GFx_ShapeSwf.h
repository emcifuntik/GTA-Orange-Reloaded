...
//    void    SetRectBoundsLocal(const RectF& r) { Bound = r; }
    ...
    // I/O
    virtual void Read(LoadProcess* p, TagType tagType, unsigned lenInBytes, bool withStyle) =0;
...
public:
    ...
    // I/O
    virtual void Read(LoadProcess* p, TagType tagType, unsigned lenInBytes, bool withStyle);
...
{
public:
    ImageShapeCharacterDef(ImageResource* pimage, ImageCreator* imgCreator);
