...
private:
    ...
    mutable InteractiveObject*   pCachedChar;
...
private:
    ...
    void SwapRenderTreeNodes(DisplayObjectBase* owner, UPInt index1, UPInt index2);
public:
    DisplayList();
    ~DisplayList()
    {
...
//    void            Display(DisplayContext &context);
    ...
    void            SwapEntriesAtIndexes(DisplayObjectBase* owner, UPInt origIndex1, UPInt origIndex2);
    ...
    InteractiveObject* GetDisplayObjectByName(const ASString& name, bool caseSensitive = true) const;    
