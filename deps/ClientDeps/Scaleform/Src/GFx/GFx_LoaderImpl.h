...
public:
    ...
    */
    ...
    // This is called only for custom 'img:/' protocols, so heap will commonly belong to GFxMovie.
//@IMG
    //     static ImageResource*   LoadMovieImage(const char *purl, ImageLoader *ploder, Log *plog,
//                                            MemoryHeap* pheap);
