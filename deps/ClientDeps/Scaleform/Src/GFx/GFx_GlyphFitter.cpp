...
//------------------------------------------------------------------------
void GlyphFitter::ClearAndRelease()
{ 
...
//------------------------------------------------------------------------
void GlyphFitter::MoveTo(int x, int y)
{
    ContourType c;
    VertexType  v;
    c.NumVertices = 1;
...
//------------------------------------------------------------------------
void GlyphFitter::LineTo(int x, int y)
{
                                     ...
                                     int lowerCaseTop, int upperCaseTop)
{
    ...
    ArrayUnsafeLH_POD<SInt16>& ramp = (dir == FitX) ? LerpRampX : LerpRampY;
