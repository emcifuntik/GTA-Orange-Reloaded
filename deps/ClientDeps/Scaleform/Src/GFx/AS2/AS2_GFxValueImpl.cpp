...
#include "AS2/AS2_AvmCharacter.h"
#include "AS2/AS2_AvmTextField.h"
...
Value_AS2ObjectData::Value_AS2ObjectData(const Value::ObjectInterface* i, void* pdata, bool isdobj)
{
    ...
    pRoot   = static_cast<AS2::MovieRoot*>(pmovieImpl->pASMovieRoot);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::HasMember", Amp_Native_Function_Id_ObjectInterface_HasMember);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::GetMember", Amp_Native_Function_Id_ObjectInterface_GetMember);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::SetMember", Amp_Native_Function_Id_ObjectInterface_SetMember);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::Invoke", Amp_Native_Function_Id_ObjectInterface_Invoke);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::DeleteMember", Amp_Native_Function_Id_ObjectInterface_DeleteMember);
    Value_AS2ObjectData o(this, pdata, isdobj);
    if (!o.pObject)
        return false;
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::VisitMembers", Amp_Native_Function_Id_ObjectInterface_VisitMembers);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::GetArraySize", Amp_Native_Function_Id_ObjectInterface_GetArraySize);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::SetArraySize", Amp_Native_Function_Id_ObjectInterface_SetArraySize);
    AS2::ObjectInterface* pobj = static_cast<AS2::ObjectInterface*>(pdata);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::GetElement", Amp_Native_Function_Id_ObjectInterface_GetElement);
    AS2::ObjectInterface*   pobj = static_cast<AS2::ObjectInterface*>(pdata);
    const AS2::ArrayObject* parr = static_cast<const AS2::ArrayObject*>(pobj);
    ...
    AS2::MovieRoot*   proot = static_cast<AS2::MovieRoot*>(GetMovieImpl()->pASMovieRoot);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::SetElement", Amp_Native_Function_Id_ObjectInterface_SetElement);
    AS2::ObjectInterface* pobj = static_cast<AS2::ObjectInterface*>(pdata);
    AS2::ArrayObject*     parr = static_cast<AS2::ArrayObject*>(pobj);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::VisitElements", Amp_Native_Function_Id_ObjectInterface_VisitElements);
    AS2::ObjectInterface* pobj = static_cast<AS2::ObjectInterface*>(pdata);
    AS2::ArrayObject*     parr = static_cast<AS2::ArrayObject*>(pobj);
    AS2::MovieRoot*       proot= static_cast<AS2::MovieRoot*>(GetMovieImpl()->pASMovieRoot);
    AS2::Environment*     penv = AS2::ToAvmSprite(proot->GetLevel0Movie())->GetASEnvironment();
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::PushBack", Amp_Native_Function_Id_ObjectInterface_PushBack);
    AS2::ObjectInterface* pobj = static_cast<AS2::ObjectInterface*>(pdata);
    AS2::ArrayObject*     parr = static_cast<AS2::ArrayObject*>(pobj);
    AS2::MovieRoot*       proot= static_cast<AS2::MovieRoot*>(GetMovieImpl()->pASMovieRoot);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::PopBack", Amp_Native_Function_Id_ObjectInterface_PopBack);
    AS2::ObjectInterface* pobj = static_cast<AS2::ObjectInterface*>(pdata);
    AS2::ArrayObject*     parr = static_cast<AS2::ArrayObject*>(pobj);
    AS2::MovieRoot*       proot= static_cast<AS2::MovieRoot*>(GetMovieImpl()->pASMovieRoot);
    AS2::Environment*     penv = AS2::ToAvmSprite(proot->GetLevel0Movie())->GetASEnvironment();
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::RemoveElements", Amp_Native_Function_Id_ObjectInterface_RemoveElements);
    AS2::ObjectInterface* pobj = static_cast<AS2::ObjectInterface*>(pdata);
    AS2::ArrayObject*     parr = static_cast<AS2::ArrayObject*>(pobj);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::GetDisplayMatrix", Amp_Native_Function_Id_ObjectInterface_GetDisplayMatrix);
    CharacterHandle* pch = static_cast<CharacterHandle*>(pdata);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::SetDisplayMatrix", Amp_Native_Function_Id_ObjectInterface_SetDisplayMatrix);
    CharacterHandle* pch = static_cast<CharacterHandle*>(pdata);
    DisplayObject*   pd = pch->ResolveCharacter(GetMovieImpl());
    if (!pd) return false;
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::GetMatrix3D", Amp_Native_Function_Id_ObjectInterface_GetMatrix3D);
    CharacterHandle* pch = static_cast<CharacterHandle*>(pdata);
    DisplayObject*   pd = pch->ResolveCharacter(GetMovieImpl());
    if (!pd) return false;
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::SetMatrix3D", Amp_Native_Function_Id_ObjectInterface_SetMatrix3D);
    CharacterHandle* pch = static_cast<CharacterHandle*>(pdata);
    DisplayObject*   pd = pch->ResolveCharacter(GetMovieImpl());
    if (!pd) return false;
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::IsDisplayObjectActive", Amp_Native_Function_Id_ObjectInterface_IsDisplayObjectActive);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::GetDisplayInfo", Amp_Native_Function_Id_ObjectInterface_GetDisplayInfo);
    CharacterHandle* pch = static_cast<CharacterHandle*>(pdata);
    DisplayObject*   pd = pch->ResolveCharacter(GetMovieImpl());
    if (!pd) return false;
    ...
    else
    {
        ...
        if (!pd->GetProjectionMatrix3D(&matProj))
            pd->GetMovieImpl()->GetRenderRoot()->GetProjectionMatrix3D(&matProj);
        pinfo->SetProjectionMatrix3D(&matProj);

        Matrix3F matView;
        if (!pd->GetViewMatrix3D(&matView))
            pd->GetMovieImpl()->GetRenderRoot()->GetViewMatrix3D(&matView);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::SetDisplayInfo", Amp_Native_Function_Id_ObjectInterface_SetDisplayInfo);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::SetText", Amp_Native_Function_Id_ObjectInterface_SetText);
    CharacterHandle* pch = static_cast<CharacterHandle*>(pdata);
    DisplayObject*   pd = pch->ResolveCharacter(GetMovieImpl());
    if (!pd) return false;
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::GetText", Amp_Native_Function_Id_ObjectInterface_GetText);
    CharacterHandle* pch = static_cast<CharacterHandle*>(pdata);
    DisplayObject*   pd = pch->ResolveCharacter(GetMovieImpl());
    if (!pd) return false;
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::GotoAndPlay", Amp_Native_Function_Id_ObjectInterface_GotoAndPlay);
    CharacterHandle* pch = static_cast<CharacterHandle*>(pdata);
    DisplayObject*   pd = pch->ResolveCharacter(GetMovieImpl());
    if (!pd || !pd->IsSprite())
        return false;
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::GetCxform", Amp_Native_Function_Id_ObjectInterface_GetCxform);
...
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::SetCxform", Amp_Native_Function_Id_ObjectInterface_SetCxform);
...
bool GFX_Value_ObjectInterface_CLASS::CreateEmptyMovieClip(void* pdata, GFx::Value* pmc, 
                                                     const char* instanceName, SInt32 depth)
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::CreateEmptyMovieClip", Amp_Native_Function_Id_ObjectInterface_CreateEmptyMovieClip);
...
bool GFX_Value_ObjectInterface_CLASS::AttachMovie(void* pdata, GFx::Value* pmc, 
                                            ...
                                            SInt32 depth, const MemberValueSet* initArgs)
{
    SF_AMP_SCOPE_TIMER_ID(GetMovieImpl()->AdvanceStats, "ObjectInterface::AttachMovie", Amp_Native_Function_Id_ObjectInterface_AttachMovie);
