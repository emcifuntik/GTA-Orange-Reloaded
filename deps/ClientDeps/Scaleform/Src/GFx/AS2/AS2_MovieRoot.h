...
Filename    :   GFx/AS2/AS2_MovieRoot.h
...
public:
    ...
    virtual void        CreateFunction(GFx::Value* pvalue, GFx::FunctionHandler* pfc, 
                                     void* puserData = NULL);
    //bool                SetVariable(const char* pathToVar, const Value &val, Movie::SetVarType setType);
    ...
    virtual bool        AttachDisplayCallback(const char* ppathToObject,
        void (SF_CDECL *callback)(void* puser), void* puser);
