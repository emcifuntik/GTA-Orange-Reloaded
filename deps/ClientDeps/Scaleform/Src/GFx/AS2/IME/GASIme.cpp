...
void GASImeCtorFunction::GetConversionMode(const FnCall& fn)
{
    ...
    if(pimeManager)
    {
        resultStr = ((IMEManager*)(pimeManager.GetPtr()))->GetConversionMode();
    }
...
void GASImeCtorFunction::SetCompositionString(const FnCall& fn)
{
    ...
    bool result = false; 
    if(pimeManager)
        result = ((IMEManager*)(pimeManager.GetPtr()))->SetCompositionString(fn.Arg(0).ToString(fn.Env).ToCStr());
...
void GASImeCtorFunction::SetConversionMode(const FnCall& fn)
{
    ...
    bool result = false;
    if(pimeManager)
        result = ((IMEManager*)(pimeManager.GetPtr()))->SetConversionMode((unsigned)(fn.Arg(0).ToNumber(fn.Env)));
...
void GASImeCtorFunction::SetEnabled(const FnCall& fn)
{
    ...
    bool result = false;
    if(pimeManager)
        result = ((IMEManager*)(pimeManager.GetPtr()))->SetEnabled(fn.Arg(0).ToBool(fn.Env));
...
void GASImeCtorFunction::GetEnabled(const FnCall& fn)
{
    ...
    Ptr<IMEManagerBase> pimeManager = fn.Env->GetMovieImpl()->GetIMEManager();
    if(pimeManager)
        fn.Result->SetBool(((IMEManager*)(pimeManager.GetPtr()))->GetEnabled());
}
