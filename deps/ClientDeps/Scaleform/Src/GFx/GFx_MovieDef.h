...
public:
    ...
    public:
        ...
        void                InitImageFileMovieDef(unsigned fileLength,
    ...
    void    InitImageFileMovieDef(unsigned fileLength,
                                  ...
                                  bool bilinear = 1)
    {
        pData->InitImageFileMovieDef(fileLength, pimageResource, imgCreator, bilinear);
    }
...
//@IMG    Ptr<ImagePacker> pImagePacker;
