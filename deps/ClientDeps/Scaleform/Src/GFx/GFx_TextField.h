...
namespace Text {
    ...
    using Render::Text::EditorKitBase;
...
private:
    ...
    struct RestrictParams : public NewOverrideBase<StatMV_ActionScript_Mem>
    {
    ...
    bool                    ParseRestrict(const ASString& restrStr);
public:
    void SetDirtyFlag();
...
public:
    ...
    //virtual bool            DoesAcceptMouseFocus() const { return !IsReadOnly() || IsSelectable(); }
    ...
    const ASString*         GetRestrict() const;
    void                    ClearRestrict();
    ...
    void                    SetFilters(const TextFilter& f);
