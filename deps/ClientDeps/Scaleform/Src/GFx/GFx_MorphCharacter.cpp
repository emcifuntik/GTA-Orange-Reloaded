...
RectF MorphCharacterDef::GetBoundsLocal() const
{
...
{ 
    //@TODO: implement correct way to hittest morphed shape!
    return pShape1->DefPointTestLocal(pShapeMeshProvider, pt, testShape, pinst) ||
           pShape2->DefPointTestLocal(pShapeMeshProvider, pt, testShape, pinst); 
}
