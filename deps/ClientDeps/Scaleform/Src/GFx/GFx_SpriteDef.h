...
public:
    ...
    bool                    GetLabeledFrame(const char* label, unsigned* frameNumber, bool translateNumbers = 1)
    {
        return MovieDataDef::TranslateFrameString(NamedFrames, label, frameNumber, translateNumbers);        
    }
    const String*           GetFrameLabel(unsigned frameNumber, unsigned* exactFrameNumberForLabel = NULL)
    {
...
public:
    ...
    struct SourceTags
    {
        ...
        GFxPlaceObjectBase*         pTextFilterTag;
        ...
        SourceTags() 
            : pMainTag(0), pMatrixTag(0), pCxFormTag(0), pTextFilterTag(0), 
        ...
        {
            pMainTag = pMatrixTag = pCxFormTag = pTextFilterTag = 
        ...
        SF_INLINE void Union(GFxPlaceObjectBase* ptag)
        {
            ...
            if (flags.HasTextFilter())  pTextFilterTag = ptag;
