...
ImGuiStyle::ImGuiStyle()
{
    ...
    WindowTitleAlign        = ImVec2(0.01f,0.5f);// Alignment for title bar text
    ...
    DisplayWindowPadding    = ImVec2(0,0);    // Window positions are clamped to be visible within the display area by at least this amount. Only covers regular windows.
    ...
    CurveTessellationTol    = 1.15f;            // Tessellation tolerance. Decrease for highly tessellated curves (higher quality, more polygons), increase to reduce quality.

    Colors[ImGuiCol_Text]                   = ImVec4(0.90f, 0.90f, 0.90f, 1.00f);
    Colors[ImGuiCol_TextDisabled]           = ImVec4(0.60f, 0.60f, 0.60f, 1.00f);
    Colors[ImGuiCol_WindowBg]               = ImVec4(56 / 255.f, 69 / 255.f, 74 / 255.f, 0.90f);
    ...
    Colors[ImGuiCol_TitleBg]                = ImVec4(52 / 255.f, 96 / 255.f, 113 / 255.f, 0.80f);
    Colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(1.00f, 0.50f, 0.00f, 0.20f);
    Colors[ImGuiCol_TitleBgActive]          = ImVec4(52 / 255.f, 96 / 255.f, 113 / 255.f, 0.87f);
    Colors[ImGuiCol_MenuBarBg]              = ImVec4(0.40f, 0.40f, 0.55f, 0.80f);
    Colors[ImGuiCol_ScrollbarBg]            = ImVec4(51 / 255.f, 86 / 255.f, 100 / 255.f, 0.60f);
    Colors[ImGuiCol_ScrollbarGrab]          = ImVec4(50 / 255.f, 99 / 255.f, 119 / 255.f, 0.30f);
    Colors[ImGuiCol_ScrollbarGrabHovered]   = ImVec4(50 / 255.f, 99 / 255.f, 119 / 255.f, 0.40f);
    Colors[ImGuiCol_ScrollbarGrabActive]    = ImVec4(50 / 255.f, 99 / 255.f, 119 / 255.f, 0.40f);
    Colors[ImGuiCol_ComboBg]                = ImVec4(51 / 255.f, 86 / 255.f, 100 / 255.f, 0.99f);
    Colors[ImGuiCol_CheckMark]              = ImVec4(48 / 255.f, 120 / 255.f, 149 / 255.f, 0.50f);
    Colors[ImGuiCol_SliderGrab]             = ImVec4(1.00f, 1.00f, 1.00f, 0.30f);
    Colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.80f, 0.50f, 0.50f, 1.00f);
    Colors[ImGuiCol_Button]                 = ImVec4(52 / 255.f, 95 / 255.f, 112 / 255.f, 0.60f);
    Colors[ImGuiCol_ButtonHovered]          = ImVec4(52 / 255.f, 95 / 255.f, 112 / 255.f, 0.80f);
    Colors[ImGuiCol_ButtonActive]           = ImVec4(52 / 255.f, 95 / 255.f, 112 / 255.f, 1.00f);
    ...
    Colors[ImGuiCol_ResizeGrip]             = ImVec4(114 / 255.f, 144 / 255.f, 154 / 255.f, 0.30f);
    Colors[ImGuiCol_ResizeGripHovered]      = ImVec4(114 / 255.f, 144 / 255.f, 154 / 255.f, 0.60f);
    Colors[ImGuiCol_ResizeGripActive]       = ImVec4(114 / 255.f, 144 / 255.f, 154 / 255.f, 0.90f);
