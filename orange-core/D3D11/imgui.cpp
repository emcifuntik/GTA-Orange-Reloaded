...
ImGuiStyle::ImGuiStyle()
{
    ...
    Colors[ImGuiCol_WindowBg]               = ImVec4(1.00f, 0.60f, 0.00f, 0.60f);
    ...
    Colors[ImGuiCol_TitleBg]                = ImVec4(1.00f, 0.50f, 0.00f, 0.80f);
    Colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(1.00f, 0.50f, 0.00f, 0.20f);
    Colors[ImGuiCol_TitleBgActive]          = ImVec4(1.00f, 0.50f, 0.00f, 0.87f);
