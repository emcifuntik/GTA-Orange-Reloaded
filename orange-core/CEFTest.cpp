...
namespace CEF
{
	...
	void Kuchen::Init()
	{
		...
		if (CefExecuteProcess(mainArgs, nullptr, nullptr) == -1)
		{
			...
			bool test = CefInitialize(mainArgs, settings, app, nullptr);
		}
	}

	Kuchen::Kuchen(std::string uri, SIZE size, POINT position, bool plugins, bool javascript)
	{
		this->size = size;
		...
		bool test = CefBrowserHost::CreateBrowser(windowInfo, this, uri.c_str(), browserSettings, nullptr);
	}
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	bool Kuchen::OnProcessMessageReceived(CefRefPtr<CefBrowser> browser, CefProcessId source_process, CefRefPtr<CefProcessMessage> message)
	{
		log << "OnProcessMessageReceived" << std::endl;
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	bool Kuchen::GetViewRect(CefRefPtr<CefBrowser> browser, CefRect& rect)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	void Kuchen::OnPopupSize(CefRefPtr<CefBrowser> browser, const CefRect& rect)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	void Kuchen::OnPaint(CefRefPtr<CefBrowser> browser, CefRenderHandler::PaintElementType paintType, const CefRenderHandler::RectList& dirtyRects, const void* buffer, int width, int height)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	void Kuchen::OnCursorChange(CefRefPtr<CefBrowser> browser, CefCursorHandle cursor, CursorType type, const CefCursorInfo& cursorInfo)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	void Kuchen::OnLoadStart(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	void Kuchen::OnLoadEnd(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, int httpStatusCode)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	void Kuchen::OnLoadError(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, CefLoadHandler::ErrorCode errorCode, const CefString& errorText, const CefString& failedURL)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	bool Kuchen::OnBeforeBrowse(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, CefRefPtr<CefRequest> request, bool isRedirect)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	CefRequestHandler::ReturnValue Kuchen::OnBeforeResourceLoad(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, CefRefPtr<CefRequest> request, CefRefPtr<CefRequestCallback> callback)
	{
		log << "OnBeforeResourceLoad" << std::endl;
		//// Mostly the same as Kuchen::OnBeforeBrowse
		//CefURLParts urlParts;
		//if (!CefParseURL(request->GetURL(), urlParts))
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	void Kuchen::OnBeforeClose(CefRefPtr<CefBrowser> browser)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	bool Kuchen::OnBeforePopup(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, const CefString& target_url, const CefString& target_frame_name, CefLifeSpanHandler::WindowOpenDisposition target_disposition, bool user_gesture, const CefPopupFeatures& popupFeatures, CefWindowInfo& windowInfo, CefRefPtr<CefClient>& client, CefBrowserSettings& settings, bool* no_javascript_access)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	void Kuchen::OnAfterCreated(CefRefPtr<CefBrowser> browser)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	bool Kuchen::OnJSDialog(CefRefPtr<CefBrowser> browser, const CefString& origin_url, CefJSDialogHandler::JSDialogType dialog_type, const CefString& message_text, const CefString& default_prompt_text, CefRefPtr<CefJSDialogCallback> callback, bool& suppress_message)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	bool Kuchen::OnFileDialog(CefRefPtr<CefBrowser> browser, CefDialogHandler::FileDialogMode mode, const CefString& title, const CefString& default_file_name, const std::vector< CefString >& accept_types, int selected_accept_filter, CefRefPtr< CefFileDialogCallback > callback)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	void Kuchen::OnTitleChange(CefRefPtr<CefBrowser> browser, const CefString& title)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	bool Kuchen::OnTooltip(CefRefPtr<CefBrowser> browser, CefString& title)
	{
	...
	//                                                                //
	////////////////////////////////////////////////////////////////////
	bool Kuchen::OnConsoleMessage(CefRefPtr<CefBrowser> browser, const CefString& message, const CefString& source, int line)
	{
