...
VTasks::VTasks()
{
	...
	TasksArray[55] = new std::string("CTaskShovePed");
	...
	TasksArray[391] = new std::string("CTaskNMBrace");
	...
	TasksArray[416] = new std::string("CTaskNMSimple");
	...
	TasksArray[444] = new std::string("CTaskReactAndFlee");
