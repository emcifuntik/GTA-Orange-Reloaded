...
public:
	...
	virtual void CreateObject(::Hash model, float x, float y, float z, float pitch, float yaw, float roll) = 0;
...
public:
	...
	void CreateObject(::Hash model, float x, float y, float z, float pitch, float yaw, float roll);
